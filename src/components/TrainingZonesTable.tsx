    ...
    <section className="training-zones">
      ...
      <div className="training-zones-callout" role="note">
        ...
        <p>
          ...
          Practice paces for <strong>{plan.practiceRepDistance}-{unitLabel}</strong> repeats,

          anchored to your <strong>{plan.anchorLabel.toLowerCase()}</strong>.
        ...
        <p>
          ...
          <strong>sprint (SP/SP3)</strong> are the most reliable targets. Aerobic zones (REC,

          A1/EN1, A2/EN2) are usually set from current threshold or CSS — confirm with your
            ...
            {plan.rows.map((row) => (
              ...
              >
                ...
                <td>
                  ...
                  <span className="training-zones-reliability-note">{row.reliabilityNote}</span>
      ...
      <p className="plan-results-meta plan-results-disclaimer">
        ...
        Zone paces are estimates from your goal time ({offsetModelLabel.toLowerCase()} model).

        Treat each pace as roughly ±1–3 seconds per 100. They are not a substitute for lactate

        testing, CSS benchmarks, or your coach&apos;s set design. HR varies by age, fitness, and
